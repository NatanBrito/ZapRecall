...
export default function Card({numPergunta,img,pergunta,resposta,callback}){
    ...
    } else{return( <PerguntaResposta pergunta={pergunta} resposta={resposta} numPergunta={numPergunta} chamandoCallback={callback}/>)
    }
}
